...
// get the screen height and width
    ...
    document.getElementById('dialog-box').innerHTML = '<a href="#" class="button" onclick="closePopup()">X</a><div class="dialog-content"><div id="dialog-message"><p>'+ dept_details +'<p/><img src='+map_src+' width="" style="min-width:500px;max-width:900px;max-height:1700px;"></div></div>';
}